...
plt.scatter(mems, bursts, marker = 's', c='k', s=20)
#plt.show()
ax = plt.gca()
ax.set_xlabel('M')
ax.set_ylabel('B')
...
ax.annotate('Elastic \nrebound', (-0.75, -0.45), fontsize=10, fontstyle='italic')
ax.annotate('Supercycles', (-0.25, 0.12), fontsize=10, fontstyle='italic')
ax.annotate('Poisson', (-0.25, -0.12), fontsize=10, fontstyle='italic')
ax.annotate('Clustered', (0.25, 0.25), fontsize=10, fontstyle='italic') 
ax.set_aspect('equal')

fig.tight_layout(pad=1.5, w_pad=1.5, h_pad=-0.3)
